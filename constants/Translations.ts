export const TRANSLATIONS = {
  ...
  ar: {
    ...
    smartTrackInfoTitle: "تتبع الذكاء الاصطناعي",
    smartTrackInfoDesc: "يقوم الذكاء الاصطناعي بالاستماع إليك أثناء قراءة الأذكار ويقوم بتظليل الكلمات تلقائياً، كما يقوم بزيادة العداد عند انتهائك من الذكر!",
